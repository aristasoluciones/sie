...
if(isset($editarred)){
?>
	<input type="hidden" name="type" value="UpdateCabeceraRed">
<?php
} else{
?>
...
<input type="hidden" name="redId" value="<?php echo @$redId?>">
...
<tr>
	<td>
		<b>Numero Bingo:</b><br>
		<div class="marcotxt">
			<input type="text" name="bingo" id="bingo" class="txtpaciente" value="<?php echo $InfoPeo["bingo"]?>">
		</div>
	</td>
	<td></td>
	<td></td>
...
<div id="Respuestaajaxedit"></div>
<img id="loader_gifEdit" src="img/r5.gif" style=" display:none;" width=15%/><br>
<?php
if(isset($editarred)){
?>

	<input type="button" onClick="UpdateCabeceraRed()" value="Editar" class="btnsave" id="UpdateCabecera"><br>
<?php
} else{
?>
