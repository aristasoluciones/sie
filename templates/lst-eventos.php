...
<?php
	...
	<tr align="center">
		...
		<td>		      
			Consulta que dia Cae tu Fecha conmemorativa  <center><input type="date"  class="marcotxt"name="fecha"></center>
		</td>
	</tr>		
	</table>
	<table>
	...
	<table>
			...
			<tr>
			     <td>  
					 <center><p><textarea name="comentario" class="marcotxt" rows="10" cols="50">Escribe tu apoyo: </textarea></p></center>
				 </td>			 
				 
			</tr>
		
	</table>         			 
		    <center><input type="button" onClick="agregaEvento()" value="GUARDAR" class="btnsave" id="agregaEvento"><br></center>
	  	</form>
	</div>
	<?php
		// include('paginacion.php');
