...
// include_once(DOC_ROOT.'/libraries.php'); 
	...
	$filtro ="";
		...
		// echo "<pre>"; print_r($_POST["idPrint"]);
	// exit;
	foreach($_POST["idPrint"] as $key=>$aux){
		$filtro ="";
			$filtro .= "and p.representanteId ='".$key."'";
			
		$sqli ="select * from people where peopleId = ".$key."";
		$rowi=mysql_query($sqli);
		$datai=mysql_fetch_assoc($rowi);
